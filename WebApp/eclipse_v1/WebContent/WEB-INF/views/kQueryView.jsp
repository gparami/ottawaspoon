						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th scope="col" class="cell100 column4 text-center">Join Date</th>
									...
									<th scope="col" class="cell100 column4 text-center">Open Date</th>
								</tr>
							</thead>
						</table>
					</div>
							...
							<tbody>
								<c:forEach items="${kBeans}" var="row">
								    <tr class="row100 body">
								      ...
								      <td class="cell100 column4">${row.join_date}</td>
