...
<html lang="en">
	<head>
		<title>OttawaSpoon - Query E</title>
		<meta charset="utf-8">
		 ...
		 <nav class="navbar navbar-expand-lg main-navbar">
			<div class="container-fluid">
				<div class="collapse navbar-collapse" id="navbarNav">
					<div class="hero bg-overlay text py-1"> <h1>Query E</h1></div>
						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th scope="col" class="cell100 column3 text-center">Meal Type</th>
									<th scope="col" class="cell100 column5 text-center">Average Price</th>
								</tr>
							</thead>
						</table>
					</div>
							...
							<tbody>
								<c:forEach items="${results}" var="row">
								    <tr class="row100 body">
								      ...
								      <td class="cell100 column3">${row.category}</td>
								      <td class="cell100 column5">${row.avg}</td>
								    </tr>
								  </c:forEach>
							</tbody>
						</table>
