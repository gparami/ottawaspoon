...
public class CookieFilter implements Filter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        Rater userInSession = ServerUtils.getLoginedUser(session);
        // 
        ...
        if (checked == null && conn != null) {
            String userName = ServerUtils.getUserNameInCookie(req);
            try {
                Rater user = DatabaseUtils.findUser(conn, userName);
