...
public class ServerUtils {
    ...
    public static void storeLoginedUser(HttpSession session, Rater loginedUser) {
        // On the JSP can access via ${loginedUser}
        session.setAttribute("loginedUser", loginedUser);
    }
 
    // Get the user information stored in the session.
    public static Rater getLoginedUser(HttpSession session) {
        Rater loginedUser = (Rater) session.getAttribute("loginedUser");
        return loginedUser;
    }
